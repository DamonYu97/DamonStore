        ...
        <div class="navbar-default sidebar col-lg-3" role="navigation">
            <div class="sidebar-nav container">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="${PATH}/member/unreceivedOrders"> Unreceived orders</a></li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
        ...
        success:function (data) {
            ...
            for (let i =0; i < data.length; i++) {
                ...
                orderHtml += '            </ul>\n' +
                    ...
                    '                   <button class="btn btn-danger" data-toggle="modal" data-target="#confirmModal" data-price=\"' +
    ...
    $('#confirmModal').on('show.bs.modal', function (event) {
        ...
        $('#operation').html(goConfirmButton);
    });
